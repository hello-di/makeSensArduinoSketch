...
void hal_aci_tl_init(void)
{
  ...
  SPI.setClockDivider(SPI_CLOCK_DIV8); /* This will run the SPI at 2MHz assuming a 16MHz clock to the mcu*/
...
hal_aci_data_t * hal_aci_tl_poll_get(void)
{
  ...
  //PCintPort::attachInterrupt(HAL_IO_RADIO_RDY, m_rdy_line_handle, FALLING);  
